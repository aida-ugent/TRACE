...
export function ResetButton(props) {
  return (
    <button
      type="button"
      className="select-none inline-block rounded-full bg-slate-500 mx-2 p-2 text-sm font-medium leading-normal 
      text-white border-none hover:no-underline hover:opacity-75 hover:bg-slate-800 focus:opacity-100 focus:shadow-none focus:outline-none"
